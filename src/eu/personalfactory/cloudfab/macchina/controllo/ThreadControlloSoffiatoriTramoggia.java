 ...
 */
public class ThreadControlloSoffiatoriTramoggia extends Thread {

    private Controllo controllo; 

    //COSTRUTTORE
    public ThreadControlloSoffiatoriTramoggia(Controllo controllo) {
    ...
    public void run() {
        ...
        ControlloLogger.logger.config("Inizio Controllo Soffiatori Tramoggia");

        controllo.pannelloControllo.impostaMessaggioEsito("TEST " + EstraiStringaHtml(TrovaVocabolo(ID_DIZIONARIO_MESSAGGI_MACCHINA, 1055, ParametriSingolaMacchina.parametri.get(111))),
                EstraiStringaHtml(TrovaVocabolo(ID_DIZIONARIO_MESSAGGI_MACCHINA, 1057, ParametriSingolaMacchina.parametri.get(111))));
        ...
        while (!controllo.avvio
            ...
            try {
                ThreadControlloSoffiatoriTramoggia.sleep(
        ...
        if (controllo.testSuperato) {
            ...
            controllo.pannelloControllo.impostaMessaggioEsito("TEST " + EstraiStringaHtml(TrovaVocabolo(ID_DIZIONARIO_MESSAGGI_MACCHINA, 1055, ParametriSingolaMacchina.parametri.get(111))),
                    "TEST " +EstraiStringaHtml(TrovaVocabolo(ID_DIZIONARIO_MESSAGGI_MACCHINA, 1055, ParametriSingolaMacchina.parametri.get(111)))
                    + " "
            ...
            //Memorizzazione Logger Procedure di Controllo
            ControlloLogger.logger.info("Controllo Soffiatori Tramoggia di Carico Superato");
            ...
            //Memorizzazione Logger Procedure di Controllo
            ControlloLogger.logger.severe("Controllo Soffiatori Tramoggia di Carico Fallito");
        ...
        //Memorizzazione Logger Procedure di Controllo
        ControlloLogger.logger.config("Fine Controllo Soffiatori Tramoggia di Carico Sacco");
