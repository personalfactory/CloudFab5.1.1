 ...
 */
public class ThreadControlloSegnalatoreRosso extends Thread {

    private Controllo controllo; 

    //COSTRUTTORE
    public ThreadControlloSegnalatoreRosso(Controllo controllo) {
    ...
    public void run() {
        ...
        ControlloLogger.logger.config("Inizio Controllo Segnalatore RossoTramoggia");

        controllo.pannelloControllo.impostaMessaggioEsito("TEST " + EstraiStringaHtml(TrovaVocabolo(ID_DIZIONARIO_MESSAGGI_MACCHINA, 1063, ParametriSingolaMacchina.parametri.get(111))),
                EstraiStringaHtml(TrovaVocabolo(ID_DIZIONARIO_MESSAGGI_MACCHINA, 1064, ParametriSingolaMacchina.parametri.get(111))));
        ...
        while (!controllo.avvio
            ...
            try {
                ThreadControlloSegnalatoreRosso.sleep(
        ...
        if (controllo.pannelloControllo.isVisible()) {
            ...
            GestoreIO_ModificaOut(USCITA_LOGICA_SEGNALE_LUMINOSO_ROSSO,
                    OUTPUT_TRUE_CHAR);
        ...
        if (controllo.testSuperato) {
            ...
            controllo.pannelloControllo.impostaMessaggioEsito("TEST " + EstraiStringaHtml(TrovaVocabolo(ID_DIZIONARIO_MESSAGGI_MACCHINA, 1063, ParametriSingolaMacchina.parametri.get(111))),
                    "TEST " + EstraiStringaHtml(TrovaVocabolo(ID_DIZIONARIO_MESSAGGI_MACCHINA, 1063, ParametriSingolaMacchina.parametri.get(111)))
                    + " "
            ...
            //Memorizzazione Logger Procedure di Controllo
            ControlloLogger.logger.info("Controllo Segnalatore Rosso Superato");

        } else {

            controllo.pannelloControllo.impostaMessaggioEsito("TEST " + EstraiStringaHtml(TrovaVocabolo(ID_DIZIONARIO_MESSAGGI_MACCHINA, 1064, ParametriSingolaMacchina.parametri.get(111))),
                    "TEST " + EstraiStringaHtml(TrovaVocabolo(ID_DIZIONARIO_MESSAGGI_MACCHINA, 1064, ParametriSingolaMacchina.parametri.get(111)))
                    + " "
                    + ParametriGlobali.parametri.get(46)
                    + " "
            ...
            //Memorizzazione Logger Procedure di Controllo
            ControlloLogger.logger.severe("Controllo Segnalatore Rosso Fallito");
        ...
        //Memorizzazione Logger Procedure di Controllo
        ControlloLogger.logger.config("Fine Controllo Segnalatore Rosso");
